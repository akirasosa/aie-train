...
from aie.env_conf import ENV_CONF_MACHINE
...
ckpt_path = OUT_DIR / 'PPO_AIEEnv_2021-02-19_20-39-533rkjdvz5/checkpoint_6726/checkpoint-6726'

trainer.restore(str(ckpt_path))

# %%
env = AIEEnv(ENV_CONF_MACHINE, force_dense_logging=True)
obs = env.reset()
